#!/usr/bin/env -S scala-cli shebang --jvm 25 -S 3.8 -J -Xmx64G --suppress-warning-directives-in-multiple-files -q -J --sun-misc-unsafe-memory-access=allow -J -XX:+UseStringDeduplication -J -XX:+UseCompactObjectHeaders -J -XX:+UseCompressedOops -J --enable-native-access=ALL-UNNAMED
